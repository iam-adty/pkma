		...
		<div class="panel-body">
			...
			<div class="panel-body-action hidden">
				<div class="main-btn-group">
					<a href="{dashboard_url}/custom/news/update/{post_id}.html" class="btn btn-primary">Update</a>
					<a href="{dashboard_url}/custom/news/delete/{post_id}.html" class="btn btn-danger">Delete</a>
