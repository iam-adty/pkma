		...
		<div class="panel-body">
			...
			<div class="panel-body-action hidden">
				<div class="main-btn-group">
					<a href="{dashboard_url}/user/update/{user_id}.html" class="btn btn-primary">Update</a>
					<a href="{dashboard_url}/user/delete/{user_id}.html" class="btn btn-danger">Delete</a>
